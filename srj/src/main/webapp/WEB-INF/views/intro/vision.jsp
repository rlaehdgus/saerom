...
<main>
					...
					<div class="row row-middle">
						<div class="col-xl-6 col-lg-6">
							<div class="hero-caption hero-caption2">
								<h2 data-animation="fadeInLeft" data-delay=".4s">비전&연혁</h2>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="visit-tailor-area fix mt-margin">
		...
		<div class="tailor-details">
			...
			<p class="pera-top">Lorem ipsum dolor sit amet, consectetur
				adipiscing elit. Suspendisse varius enim in eros.</p>
			<p class="pera-bottom">Lorem ipsum dolor sit amet, consectetur
